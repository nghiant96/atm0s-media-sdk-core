...
import * as _m05 from "protobufjs/minimal";

// src/generated/protobuf/session.ts
import * as _m04 from "protobufjs/minimal";

// src/generated/protobuf/features.ts
import * as _m03 from "protobufjs/minimal";

// src/generated/protobuf/features.mixer.ts
import * as _m02 from "protobufjs/minimal";
...
// src/sender.ts
import {
  MediaStreamTrack as MediaStreamTrack2
} from "react-native-webrtc";
var DEFAULT_CFG2 = {
  priority: 1,
...
var TrackSender = class extends EventEmitter {
  constructor(dc, track_name, track_or_kind, cfg = DEFAULT_CFG2) {
    ...
    if (track_or_kind instanceof MediaStreamTrack2) {
...
// src/session.ts
import {
  RTCPeerConnection as RTCPeerConnection3
} from "react-native-webrtc";
...
var Session = class extends EventEmitter {
  constructor(gateway, cfg) {
    ...
    this.peer = new RTCPeerConnection3();
...
export {
  ...
  Receiver_Source as AudioMixerSource,
  BitrateControlMode,
  EventEmitter,
  Kind,
  ...
  ServerEvent_Receiver_VoiceActivity as TrackReceiverVoiceActivity,
  TrackSender,
  TrackSenderEvent,
